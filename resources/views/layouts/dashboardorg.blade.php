...
<body class="bg-[#fff0f0] min-h-screen flex items-start p-6 font-sans">
  ...
  <aside class="bg-[#f28b8b] text-white w-52 min-h-[90vh] rounded-2xl p-4 flex flex-col shadow-md">
    ...
    <nav class="flex flex-col space-y-3 text-sm font-medium">
      <a href="#"
        class="flex items-center gap-3 bg-white text-[#f28b8b] rounded-lg px-4 py-2 shadow hover:brightness-95">
      ...
      <a href="#" class="flex items-center gap-3 px-4 py-2 rounded-lg hover:bg-[#f49b9b] transition">
        <i class="fas fa-certificate text-base"></i> <span>Aktivitas</span>
      </a>
      <a href="#" class="flex items-center gap-3 px-4 py-2 rounded-lg hover:bg-[#f49b9b] transition">
        <i class="fas fa-user text-base"></i> <span>Sertifikasi</span>
      </a>
      <a href="#" class="flex items-center gap-3 px-4 py-2 rounded-lg hover:bg-[#f49b9b] transition">
        <i class="fas fa-user text-base"></i> <span>Edit Data Organisasi</span>
      </a>
    </nav>
  </aside>
  ...
  <main class="flex-1 ml-8">
    ...
    <!-- Content akan diisi oleh file view lain -->
    @yield('content')
  </main>
