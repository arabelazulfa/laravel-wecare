...
<div class="mt-6 max-w-4xl mx-auto bg-white rounded-2xl shadow-md overflow-hidden">
    ...
    <div class="p-6">
        ...
        <div class="flex items-center text-sm text-gray-600 mb-2 space-x-6">
            ...
            <span><i class="far fa-clock mr-1 text-[#f28b8b]"></i>
        ...
        <div class="flex flex-wrap gap-2 mb-6">
            <a href="{{ route('events.edit', $event->id) }}" class="inline-block text-xs bg-[#4A90E2] text-white font-bold py-2 px-4 rounded-xl hover:bg-[#357ABD] transition">
                Edit
            </a>
            ...
            <a href="{{ route('events.presention', $event->id) }}" class="inline-block text-xs bg-violet-400 hover:bg-violet-500 text-white font-bold py-2 px-4 rounded-xl hover:bg-pink-500 transition">
